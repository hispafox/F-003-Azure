...
# Scripts SOLO LECTURA: inventarían un namespace Service Bus existente.
# No crean nada (sin cleanup).
#
# COSTE: Service Bus Standard ~10 €/mes FIJOS (necesario para topics +
# filtros SQL). Bórralo desde el Portal al acabar la práctica.

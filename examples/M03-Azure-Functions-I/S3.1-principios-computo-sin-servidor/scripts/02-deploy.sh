#!/usr/bin/env bash
# 02 - Publish + zip + deploy (slide 15).
# Equivalente a `func azure functionapp publish` pero sin requerir Core Tools
# instaladas; funciona con solo dotnet + az.
...
echo
echo "Espera 30-60s al primer arranque (cold start, slide 8) y verifica:"
echo "  curl 'https://$FUNC.azurewebsites.net/api/hello?name=Pedro'"
echo
echo "Siguiente: ./03-smoke-test.sh"

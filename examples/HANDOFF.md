...
| M06 Seguridad y Auth | 🚧 4/8 — S6.1, S6.2, S6.3, S6.4 (auth desktop/MSIX) |
| M07–M11 | pendientes |

**Siguiente tarea concreta:** `M06-S6.5 — Seguridad de datos`
(`doc/M06-Seguridad-Auth/v3-actual/M06-S6.5-seguridad-datos-v3.md`).
Leer el doc primero. Probable: lógica pura (cifrado at-rest/in-transit,
clasificación de datos PII, CMK vs MMK, TLS mínimo, decisiones de
data protection) + servicio DI + CAPA 0. Patrón conceptual
S6.1–S6.4 (CAPA 1 + CAPA 0, sin integración salvo algo emulable).
Submódulos M06 restantes: S6.5 seguridad datos, S6.6 Key Vault,

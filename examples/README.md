...
| [M11 — Bonus Claude Code en Azure](M11-Bonus-Claude-Code-Azure/README.md) | S11.3 — Skills: capacidades especializadas (SKILL.md, description, anti-patrones, Azure Skills Plugin) | [Bonus.SkillsAzure.Demo.Api](M11-Bonus-Claude-Code-Azure/S11.3-skills-capacidades-especializadas/README.md) | ✅ Disponible |
...
⏳ **Módulo M11 (bonus) en construcción** (3/10 — S11.1, S11.2, S11.3 disponibles).
